...
$lang['Account_added'] = 'Tack för att du registrerade dig, ditt konto har skapats. Du kan nu logga in med ditt användarnamn och lösenord.';
$lang['Account_inactive'] = 'Tack för att du registrerade dig, ditt konto har skapats. Innan du kan använda ditt konto måste du aktivera det, en aktiveringskod har skickats till e-postadressen du angav vid registreringen. Kolla din e-post för vidare information.';
$lang['Account_inactive_admin'] = 'Ditt konto har skapats. Det här forumet kräver dock att administratören aktiverar ditt konto innan du kan använda det. Ett e-postmeddelande har skickats till administratören och du kommer att bli informerad via e-post när ditt konto aktiverats.';
...
$lang['COPPA'] = 'Ditt konto har skapats men måste godkännas, kolla din e-post för vidare information.';
...
$lang['Session_invalid'] = 'Felaktig session. Skicka om formuläret.';
