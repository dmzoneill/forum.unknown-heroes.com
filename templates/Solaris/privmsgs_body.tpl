		...
		<tr> 
		  <td colspan="3" width="175" class="row2">
			<table cellspacing="0" cellpadding="1" border="0">
			  <tr> 
				<td bgcolor="#F8A406"><img src="templates/Solaris/images/spacer.gif" width="{INBOX_LIMIT_IMG_WIDTH}" height="8" alt="{INBOX_LIMIT_PERCENT}" /></td>
			  </tr>
			</table>
		  </td>
		</tr>
	...
	<tr> 
	  <td class="tableborder">  
		  ...
		  <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
			...
			<tr> 
			  <td class="row1" colspan="5" align="center" valign="middle"><span class="genmed">{L_NO_MESSAGES}</span></td>
			</tr>
			<!-- END switch_no_messages -->
			<tr> 
			  <td class="catBottom" colspan="5" align="right"> {S_HIDDEN_FIELDS} 
