	...
	<tr>
		<td class="tableborder">  
		  ...
		  <table width="100%" cellpadding="4" cellspacing="1" border="0">
			<tr> 
			  <th class="thHead" colspan="3" nowrap="nowrap"><span class="cattitle">{L_SPLIT_TOPIC}</span></th>
			</tr>
			<tr> 
			  <td class="row1" colspan="3" align="center"><span class="gensmall">{L_SPLIT_TOPIC_EXPLAIN}</span></td>
			</tr>
			<tr> 
			  <td class="row1" nowrap="nowrap"><span class="genmed">{L_SPLIT_SUBJECT}</span></td>
			...
			<tr> 
			  ...
			  <td width="100%" valign="top" class="{postrow.ROW_CLASS}"> 
				<table width="100%" cellspacing="0" cellpadding="3" border="0">
				  <tr> 
					<td valign="middle"><img src="templates/Solaris/images/icon_minipost.gif" alt="{L_POST}"><span class="postdetails">{L_POSTED}: 
