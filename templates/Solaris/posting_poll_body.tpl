			...
			<tr>
				<th class="thHead" colspan="2"><span class="cattitle">{L_ADD_A_POLL}</span></th>
	        </tr>
			<tr>
				<td class="row1" colspan="2"><span class="gensmall">{L_ADD_POLL_EXPLAIN}</span></td>
	        </tr>
            <tr>
				<td class="row1"><span class="genmed"><b>{L_POLL_QUESTION}</b></span></td>
            ...
            <tr>
				<td class="row1"><span class="genmed"><b>{L_POLL_OPTION}</b></span></td>
            ...
            <tr>
				<td class="row1"><span class="genmed"><b>{L_POLL_LENGTH}</b></span></td>
				<td class="row2"><span class="genmed"><input type="text" name="poll_length" size="3" maxlength="3" class="post" value="{POLL_LENGTH}" /></span>&nbsp;<span class="genmed"><b>{L_DAYS}</b></span> &nbsp; <span class="gensmall">{L_POLL_LENGTH_EXPLAIN}</span></td>
			</tr>
