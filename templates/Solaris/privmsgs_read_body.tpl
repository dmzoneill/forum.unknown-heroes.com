	...
	<tr> 
	  <td class="tableborder">  
		...
		<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
			<tr> 
			  <th colspan="3" class="thHead" nowrap="nowrap"><span class="cattitle">{BOX_NAME} :: {L_MESSAGE}</span></th>
			</tr>
			<tr> 
			  <td class="row1"><span class="genmed"><strong>{L_FROM}</strong></span></td>
			  <td width="100%" class="row2" colspan="2"><span class="genmed">{MESSAGE_FROM}</span></td>
			</tr>
			<tr> 
			  <td class="row1"><span class="genmed"><strong>{L_TO}</strong></span></td>
			  <td width="100%" class="row2" colspan="2"><span class="genmed">{MESSAGE_TO}</span></td>
			</tr>
			<tr> 
			  <td class="row1"><span class="genmed"><strong>{L_POSTED}</strong></span></td>
			  <td width="100%" class="row2" colspan="2"><span class="genmed">{POST_DATE}</span></td>
			</tr>
			<tr> 
			  <td class="row1"><span class="genmed"><strong>{L_SUBJECT}</strong></span></td>
