	...
	<tr>
		<td class="tableborder">  
			...
			<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
			  <tr> 
				<th class="thHead"><span class="cattitle">{L_IP_INFO}</span></th>
			  </tr>
			  <tr> 
				...
				<td class="row1"> 
				  <table width="100%" cellspacing="0" cellpadding="0" border="0">
					<tr> 
					  ...
					  <td align="right"><span class="genmed">[ <a href="{U_LOOKUP_IP}">{L_LOOKUP_IP}</a> 
						]&nbsp;</span></td>
					</tr>
				  </table>
				</td>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0">
						<tr> 
						  <td>&nbsp;<span class="genmed">{iprow.IP} [ {iprow.POSTS} ]</span></td>
					  	  <td align="right"><span class="genmed">[ <a href="{iprow.U_LOOKUP_IP}">{L_LOOKUP_IP}</a> 
						]&nbsp;</span></td>
						</tr>
				  </table>
